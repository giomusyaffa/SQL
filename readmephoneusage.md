...
## Project Overview  
This project analyze the correlation between screen time, sleep quality, stress level, caffeine intake, etc.
...
### 2. Duplicate Values
This is also important to check to avoid unnecessary error in analyzing the data
<img width="1919" height="934" alt="image" src="https://github.com/user-attachments/assets/2d0c1222-71a8-47c5-9aa2-8224ce57058e" />

As we can see from the query above by using `HAVING` clause  with the `COUNT()` function, we can filter groups of data based on the count of rows within each group.

In this case for the User ID which is crutial to not have duplicated values.
