...
This project explores financial transaction data using SQL to identify suspicious patterns related to money laundering. 

The dataset is generated by IBM using a realistic multi-agent simulation, making it ideal for practicing fraud analytics, transaction monitoring, and investigative SQL queries.
##### **Project Link:**
